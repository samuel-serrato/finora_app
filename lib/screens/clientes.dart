...
class _ClientesScreenMobileState extends State<ClientesScreenMobile>
  ...
  String? _estadoClienteSeleccionadoFiltroAPI;

  // (El resto de tus métodos initState, dispose, obtenerClientes, etc. se mantienen igual)
  // ...
  ...
  Widget build(BuildContext context) {
    ...
    return ResponsiveScaffoldListView<Cliente>(
      ...
      cardBuilder:
          (context, cliente) => _buildStandardClienteCard(cliente, colors),
      tableRowCardBuilder:
          (context, cliente) => _buildTableRowClienteCard(cliente, colors),
      cardHeight: 180,
  ...
  Widget _buildStandardClienteCard(Cliente cliente, dynamic colors) {
    final fullName =
        '${cliente.clienteInfo.nombres} ${cliente.clienteInfo.apellidoP}'
            .trim();
                ...
                Row(
                  ...
                  children: [
                    Container(
                      ...
                      child: Text(
                        cliente.clienteInfo.tipoCliente,
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        _buildInfoChip(
                          Icons.phone_rounded,
                          cliente.clienteInfo.telefono ?? 'N/A',
                          Colors.teal,
                          colors,
                        ),
                        _buildInfoChip(
                          esFemenino
                              ...
                              : Icons.male_rounded,
                          cliente.clienteInfo.sexo,
                          esFemenino ? Colors.purple : Colors.blue,
                          colors,
                        ),
                      ],
                    ),
  ...
  PopupMenuButton<String> _buildPopupMenu(Cliente cliente, dynamic colors) =>
    ...
    return SizedBox(
      ...
      child: ListView(
        ...
        children:
            estados.map((estado) {
              final isSelected =
                  (_estadoClienteSeleccionadoFiltroAPI == null &&
                      estado == 'Todos') ||
                  (_estadoClienteSeleccionadoFiltroAPI == estado);
              return Padding(
                ...
                child: FilterChip(
                  ...
                  onSelected: (selected) {
                    if (selected) {
                      setState(
                        () =>
                            _estadoClienteSeleccionadoFiltroAPI =
    ...
    try {
      ...
      if (response.success) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              response.error ?? 'Ocurrió un error al intentar eliminar.',
            ),
